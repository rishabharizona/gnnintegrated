...
if __name__ == '__main__':
    ...
    # Domain alignment
    args.domain_align_weight = 0.5  # Stronger alignment
    
    # Curriculum adjustments
    args.CL_PHASE_EPOCHS = [5, 7, 10]  # More epochs in later stages
    args.CL_DIFFICULTY = [0.4, 0.6, 0.8]  # Focus on harder samples
    
    # Regularization
    args.weight_decay = 5e-5  # Slight weight decay
    args.lambda_dis = 0.05    # Moderate diversity loss
    args.batch_size = 64      # Larger batches for better generalization
